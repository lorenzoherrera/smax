<?php
	 ...
	 * @category Engine
	 */
	class RatingFromOther extends Rating {
		/**
		...
		function getDescription() {
			return "Rating added by another user";
		}
		...
		function getCertainty($attitude = ATTITUDE_DEFAULT) {
			$certaintyTable = Main::getAlgorithmKey("certaintyTable", RATING_TYPE_FROM_OTHER, $attitude);
		...
		function getPower($attitude = ATTITUDE_DEFAULT) {
			return Main::getAlgorithmKey("power", RATING_TYPE_FROM_OTHER, $attitude);
		}
	}
