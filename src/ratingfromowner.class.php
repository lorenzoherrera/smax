<?php
	 ...
	 * @category Engine
	 */
	class RatingFromOwner extends Rating {
		/**
		...
		function getCertainty($attitude = ATTITUDE_DEFAULT) {
			$certaintyTable = Main::getAlgorithmKey("certaintyTable", RATING_TYPE_FROM_OWNER, $attitude);
		...
		function getPower($attitude = ATTITUDE_DEFAULT) {
			return Main::getAlgorithmKey("power", RATING_TYPE_FROM_OWNER, $attitude);
		}
	}
